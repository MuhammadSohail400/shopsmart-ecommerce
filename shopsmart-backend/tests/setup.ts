...
vi.mock('@prisma/client', () => ({
  ...
  PaymentMethod: { card: 'card', cod: 'cod', bank_transfer: 'bank_transfer' },
  PaymentStatus: {
    pending: 'pending',
    succeeded: 'succeeded',
    failed: 'failed',
  ...
  RefundStatus: { pending: 'pending', succeeded: 'succeeded', failed: 'failed' },
  ShipmentStatus: { pending: 'pending', shipped: 'shipped', in_transit: 'in_transit', delivered: 'delivered', failed: 'failed' },
  Prisma: {},
